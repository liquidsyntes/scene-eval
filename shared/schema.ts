...
export const evaluations = pgTable("evaluations", {
  ...
  storyRating: integer("story_rating"),
  storyRatingReason: text("story_rating_reason"),
  // Block 4
  ...
  partnerContactRating: integer("partner_contact_rating"),
  partnerContactRatingReason: text("partner_contact_rating_reason"),
  audienceContact: text("audience_contact"),
  audienceLoss: text("audience_loss"),
  audienceContactRating: integer("audience_contact_rating"),
  audienceContactRatingReason: text("audience_contact_rating_reason"),
  ...
  costumeBudget: text("costume_budget"),
  propsWorked: text("props_worked"),
  propsIssues: text("props_issues"),
  musicUsed: text("music_used"),
